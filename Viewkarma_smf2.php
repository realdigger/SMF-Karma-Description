...
function KarmaMessage()
{
        ...
        //Avatar
        if (!empty($user_profile[$_REQUEST['u']]['avatar']) && (substr($user_profile[$_REQUEST['u']]['avatar'],0,7)!='http://'))
        ...
        $context['linktree'][] = array(
                ...
                'name' => $txt['viewkarma_title'] );
        $context['page_index'] = constructPageIndex($scripturl . '?action=karmamessage;u=' . $_REQUEST['u'] . ';topic='.$_REQUEST['topic'].';m='.$_REQUEST['m'].'' ,$_REQUEST['start'], $totalActions, $modSettings['karmamaxmembers']);
        $context['start'] = $_REQUEST['start'];
        $context['totalActions'] = $totalActions;
